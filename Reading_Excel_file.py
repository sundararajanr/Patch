...
wb =openpyxl.load_workbook('/var/lib/awx/projects/_4__demo_project/Server_Inventory_Linux.xlsx')
source = wb['Sheet1']
...
#    print(data)
    ...
    stream = open('/var/lib/awx/projects/_4__demo_project/Change_creation.yml', 'w')
...
for x in range(1,user_data.max_row+1):
    ...
    os.system ('ansible-playbook /var/lib/awx/projects/_4__demo_project/Change_creation.yml')
